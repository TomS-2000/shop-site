            ...
            {mainCategories.map(({category, subCategories}) => (
                ...
                <motion.div key={category} onHoverStart={() => setActiveCategory(category)} onHoverEnd={() => setActiveCategory(null)} className='relative' >
                    ...
                    {subCategories.length >= 2 && (
                        <div className={activeCategory === category ? 'bg-neutral-200 dark:bg-neutral-700 rounded-t-lg' : ''}>
                    ...
                    {activeCategory === category && (
                        <div className="absolute top-9 p-2 bg-neutral-200 dark:bg-neutral-700 rounded-b-lg rounded-tr-lg shadow-lg z-10">
